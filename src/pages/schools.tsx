    ...
    <Layout title="School Rankings | UAIU Sports Championship">
      ...
      <div className="relative z-10 w-full min-h-screen pt-32 pb-24 px-5 md:px-10">
        <div className="mx-auto max-w-[1400px]">
          ...
          <Reveal delay={0.3}>
            <SectionHeading
              kicker="House Standings"
              title="House Rankings"
              sub="The four houses compete for supremacy across all sports."
            />
          </Reveal>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            {houses.map((house, index) => {
              const rank = index + 1;
              const houseColors = ["#D4AF37", "#C0C0C0", "#CD7F32", "#60A5FA"];
              const color = houseColors[rank - 1] || "#60A5FA";

              return (
                <Reveal key={house.name} delay={index * 0.1}>
                  <div className="relative rounded-2xl border border-white/10 bg-[#111]/60 p-6 backdrop-blur-sm">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div
                          className="w-10 h-10 rounded-full flex items-center justify-center font-display text-xl font-black"
                          style={{
                    ...
                    <div className="grid grid-cols-4 gap-2 text-center">
                      ...
                      <div>
                        <span className="font-display text-lg font-bold text-[#C0C0C0]">
                          {house.silver}
                        </span>
                        <div className="font-sans text-[10px] uppercase tracking-widest text-white/40">
                          Silver
                      ...
                      <div>
                        <span className="font-display text-lg font-bold text-[#CD7F32]">
                          {house.bronze}
                        </span>
                        <div className="font-sans text-[10px] uppercase tracking-widest text-white/40">
                          Bronze
